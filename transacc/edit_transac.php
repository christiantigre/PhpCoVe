                                         ...
                                         <div class="col-lg-6"> 
                                             <div class="form-group">
                                                 <div class="btn-group btn-group-xs" role="group" aria-label="...">
                                                  <button type="button" class="btn btn-warning" onclick='confirma_delet(<?Php echo $codigo; ?>,<?Php echo $monto=0; ?>,<?Php echo $pago=0; ?>,<?Php echo $tipodelete=2; ?>,<?Php echo $mensaje='"Esta seguro que desea eliminar los pagos?"'; ?>);'>Vaciar pagos</button>
