...
//            . "</td>";
            ...
            echo "<td align='center'><a href='inicio.php?variable=edit_transaccion&vertrans=".$datomarca["idtran_cab"]."' data-toggle='modal''><button type='button' title='EDITAR' class='btn btn-outline btn-info glyphicon glyphicon-edit'></button></a></td>";            
            echo "</tr>";
        }
//        echo "</table>";
    }
