...
while ($rowdet_1 = mysqli_fetch_array($resdet_1)) {
    ...
    if(($rowdet_1[1])=='CREDITO'){
        ...
        $pdf->Cell(30, 5, number_format($rowdet_1[4], 2), 0, 0, 'R');
...
$pdf->Ln(10);
$pdf->SetFont('Times', 'B', 9);
$pdf->MultiCell(180, 5, \utf8_decode('Yo, '.$comitente.', declaro recibir el vehículo cuyas características corresponden a las antes '
