...
while ($datocred = mysqli_fetch_array($rescred, MYSQLI_BOTH)) {
    ...
    if(($datocred['tran_cre_sec']) > 889){
        $tran_cre_sec   = 'ADICIONAL';
    }else{
...
$top_datos = 45;
$pdf->SetXY(15, $top_datos);
$pdf->Cell(190, 10, "Cliente:", 0, 2, "J");
$pdf->SetFont('Arial', '', 9);
$pdf->MultiCell(150, //posición X
        5, //posición Y
        "\n" .
...
$pdf->MultiCell(
        ...
        "Monto : " . number_format($tran_cre_monto, 2) . "\n" .
        "Interes : " . number_format($tran_cre_interes, 2) . "\n" .
        "Valor : " . number_format($tran_cre_cuota, 2), 0, // bordes 0 = no | 1 = si
        "J", // texto justificado
        false);
